...
- (void) onCompletedLevel:(id)sender {
    ...
    moves *= -1;
    if(moves <= 0) {
        levelCompleteLabel = [CCLabelTTF labelWithString: @"完美!" fontName:@"RTWSYueGoTrial-Regular.otf" fontSize:35];
        ...
        levelCompleteLabel = [CCLabelTTF labelWithString: @"干的漂亮" fontName:@"RTWSYueGoTrial-Regular.otf" fontSize:20];
        [levelCompleteLabel runAction:[CCFadeIn actionWithDuration:0.5]];
        ...
        if(moves == 1)
            ...
            completeText = [NSString stringWithFormat:@"再减少%i步", moves];
        levelCompleteLabel2 = [CCLabelTTF labelWithString: completeText fontName:@"RTWSYueGoTrial-Regular.otf" fontSize:20];
        [levelCompleteLabel2 runAction:[CCFadeIn actionWithDuration:0.5]];
        levelCompleteLabel2.position = ccp(160, 187);
        [levelCompleteLayer addChild:levelCompleteLabel2];
        
        levelCompleteLabel3 = [CCLabelTTF labelWithString: @"就达到完美" fontName:@"RTWSYueGoTrial-Regular.otf" fontSize:20];
        [levelCompleteLabel3 runAction:[CCFadeIn actionWithDuration:0.5]];
        levelCompleteLabel3.position = ccp(160, 164);
...
- (void) unlockAchievement:(int)achievementId {
	...
	if([achievements unlock:achievementId]) {
        ...
        CCLabelTTF* achievementTitle = [CCLabelTTF labelWithString:[achievements getName:achievementId] fontName:@"RTWSYueGoTrial-Regular.otf" fontSize:26];
        ...
        CCLabelTTF* achievementDesc = [CCLabelTTF labelWithString:[achievements getDescription:achievementId] fontName:@"RTWSYueGoTrial-Regular.otf" fontSize:20];
