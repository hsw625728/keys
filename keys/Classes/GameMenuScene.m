...
- (id) init {
	if((self=[super init])) {
        ...
        CCLabelTTF* statusLabel = [CCLabelTTF labelWithString:[NSString stringWithFormat:@"%@ * 关卡 %i", [gameData stageName], gameData.level] fontName:@"RTWSYueGoTrial-Regular.otf" fontSize:25];
